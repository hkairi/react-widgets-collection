...
var Liste= React.createClass({
  ...
  loadEvents: function(){
    var self = this,
        e    = [];
    return(
      $.get( 'http://www.agendakar.com/api/events.json').then(function(data){
        data.map(function(e){
          e.push(React.createElement(Evenement, {nom: e.nom, date: e.date_de_debut, heure: e.heure_de_debut}));
        });
        console.log(e);
        self.setState({ isLoading: false, elements: e });
      })
    )
  },
