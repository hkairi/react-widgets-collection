          ...
          React.createElement("table", {style: _style}, 
            ...
            React.createElement("tr", null, 
              React.createElement("td", {colSpan: "2"}, 
                React.createElement("a", {href: this.get_url(this.props.id), style: a, target: "_blank"}, " ", this.props.nom, " ")
              )
           )
          ), 
          React.createElement("p", {style: d}, 
            React.createElement("a", {href: this.get_url(this.props.id), style: ac, target: "_blank"}, "Voir sur agendakar.com")
          )
        )
      )
    );
