    ...
    return(
      React.createElement("li", {style: li_style, onClick: this.handleClick}, 
        React.createElement("div", null, 
          ...
          React.createElement(EvenementOptions, {url: this.get_url(_event.slug)})
          )
        )
      )
    );
...
var EvenementOptions = React.createClass({displayName: "EvenementOptions",
  render: function(){
    var ac = {
      width     : '100%',
      textAlign : 'center'
      ...
      React.createElement("table", null, 
        React.createElement("tr", null, 
          React.createElement("td", null, 
            React.createElement("a", {href: this.props.url, style: ac, target: "_blank"}, 
...
var Endroit = React.createClass({displayName: "Endroit",
  render: function(){
    ...
    return React.createElement("p", null, React.createElement("i", {className: "fa fa-map-marker", style: s}), " ",  this.props.nom)
  }
});
