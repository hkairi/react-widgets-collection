    ...
    return(
      React.createElement("li", {style: li_style, onClick: this.handleClick}, 
        ...
        React.createElement("table", {style: _style}, 
          ...
          React.createElement("tr", {style: c}, React.createElement("td", {colSpan: "2"}, React.createElement("a", {href: this.get_url(this.props.id), style: a}, " ", this.props.nom, " ")))
        )
        )
      )
    );
...
var Liste = React.createClass({
  ...
  render: function(){
    ...
    this.props.evenements.map(function(e){
      liste.push(React.createElement(Evenement, {key: e.id, id: e.id, nom: e.nom, date: e.date_de_debut, heure: e.heure_de_debut}))
    });
