...
var Liste = React.createClass({
  ...
  render: function(){
    ...
    this.props.evenements.map(function(d){
      var e = d.data;
      liste.push(
        React.createElement(Evenement, {key: e.id, id: e.slug, nom: e.nom, date: e.date_de_debut || new Date(), heure: e.heure_de_debut, endroit: e.nom_endroit, quartier: e.quartier})
      )
    });
