        ...
        React.createElement("table", {style: _style}, 
          ...
          React.createElement("tr", {style: c}, 
            React.createElement("td", {colSpan: "2"}, 
              React.createElement("a", {href: this.get_url(this.props.id)}, "Voir sur agendakar.com")
            )
          )
        )
        )
...
var Liste = React.createClass({
  ...
  render: function(){
    ...
    this.props.evenements.map(function(d){
      var e = d.data;
      liste.push(
        React.createElement(Evenement, {key: e.id, id: e.slug, nom: e.nom, date: e.date_de_debut, heure: e.heure_de_debut, endroit: e.nom_endroit, prix: e.prix})
      )
    });
